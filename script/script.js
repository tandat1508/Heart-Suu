...
var init = function () {
  ...
  var canvas = document.getElementById("heartMain");
  ...
  loop();
  setTimeout(() => {
    const heart = document.getElementById("heartMain").classList;
    heart.toggle("hidden");
    setInterval(() => {
      const container = document.getElementById("meow").classList;
